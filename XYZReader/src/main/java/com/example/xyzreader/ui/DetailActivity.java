...
/**
 * Our secondary Activity which is launched from {@link AnimatedCollapsingBaseActivity}. Has a simple detail UI
...
public class DetailActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mItem_id = getIntent().getIntExtra(EXTRA_PARAM_ID, 0);
